...
/* package han-0.1.0.0 */
#ifndef VERSION_han
#define VERSION_han "0.1.0.0"
#endif /* VERSION_han */
#ifndef MIN_VERSION_han
#define MIN_VERSION_han(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_han */
...
#define CURRENT_COMPONENT_ID "han-0.1.0.0-inplace-han"
